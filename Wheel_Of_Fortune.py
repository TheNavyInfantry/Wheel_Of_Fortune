"""Wheel of Fortune Game - Game Development Project Task
...
class WOFComputerPlayer(WOFPlayer):
    ...
    def smartCoinFlip(self):
        ...
        if randomNumber > self.difficulty:
            return True
        elif randomNumber <= self.difficulty:
            return False
    ...
    def getPossibleLetters(self,guessed):
        ...
        if self.prizeMoney >= 250:
            for pickLetter in LETTERS:
                letterList.append(pickLetter)
        else:
            for pickLetter in LETTERS:
                if pickLetter not in VOWELS:
                    letterList.append(pickLetter)
...
# GAME LOGIC CODE
print('='*20)
print('Student: Nedim Can Ulusoy\n'
      'Neptun: HUUMCJ')
print('='*20)
